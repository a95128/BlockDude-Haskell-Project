...
m2r =
  [ [Vazio, Vazio, Vazio, Vazio, Vazio, Vazio, Vazio],
    ...
    [Bloco, Bloco, Bloco, Bloco, Bloco, Vazio, Bloco]
  ] 
...
m1e4 :: Jogo
m1e4 = Jogo m1r (Jogador (6, 0) Este False) 

m1e5 :: Jogo
m1e5 = Jogo m1r (Jogador (0, 2) Oeste False)

m1e6 :: Jogo
m1e6 = Jogo m1r (Jogador (4, 2) Oeste False)

m1e7 :: Jogo
m1e7 = Jogo m1r (Jogador (0, 0) Este False)